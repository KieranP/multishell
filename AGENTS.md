...
| [docs/design/terminals.md](docs/design/terminals.md) | Where a session's state comes from, how a shell ends, injected integration, click-to-move, dropped files, agent and shell ids, and the three layers a user's Ghostty config sits in the middle of. |
...
| [docs/design/appearance.md](docs/design/appearance.md) | Hex themes, the focused pane's ring and the fade, hand-drawn window chrome, the header and row heights, a board card's four lines. |
| [docs/design/translation.md](docs/design/translation.md) | A catalogue per frontend and one for the libraries, why a view holds no literal, counted forms, and what stays in English. |
