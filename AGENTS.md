...
| [docs/design/agents.md](docs/design/agents.md) | What the socket accepts, each agent's hooks and why each event was narrowed, a settings file's numbers kept as written, the board as a roster, and flags per agent against one list of placeholders. |
...
| [docs/design/smaller-decisions.md](docs/design/smaller-decisions.md) | Eighteen one-liners: warm-up, keybinds, error mapping, help behind an (i), notification toggles, the icon palette, one banner per pane, one engine, the rest. |
