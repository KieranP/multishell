...
it runs and where, the call from WorktreeCoordinator in order, a
`PresentedError` title saying whether the operation happened, an editor in
ProjectHooksTab, a `WorktreeOperation.Step` with its text.
