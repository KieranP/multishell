...
Per sentence: what fact does it give, or what does it tell the reader to do? If
it only sets up the next sentence, or would read identically in another
project's docs, cut it.

## Never

**Em dashes.** End the sentence or use a comma. Not en dashes, double hyphens,
or parentheses instead. Colons as mid-sentence connectors (fine before a list).
Curly quotes. Title Case headings. Decorative emoji. Bullets wrapped around
prose. A heading on a four-sentence answer. Bolding every proper noun.

**Openers and closers**: Great question, You're absolutely right, Of course,
Certainly, Let me start by, I hope this helps, Let me know if. Closing
paragraphs that repeat what was just read.

**Words**, cut or use the plain one: crucial, vital, robust, seamless,
...
three. Synonym cycling. Passive voice: name the actor. Adverbs propping up weak
verbs ("runs quickly" → "is fast", or the number). Stacked hedges.
