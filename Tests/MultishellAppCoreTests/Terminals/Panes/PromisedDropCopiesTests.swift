...
struct PromisedDropCopiesTests {
  ...
  @Test func aDragOfBothKindsKeepsTheFilesTheUserHas() {
    ...
    #expect(PromisedDropCopies.originals(among: [mine, copy]) == [mine])
    #expect(PromisedDropCopies.originals(among: [copy]).isEmpty)
    #expect(PromisedDropCopies.originals(among: [mine]) == [mine])
