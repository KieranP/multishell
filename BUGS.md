...
never reused and a fixed entry is taken out rather than kept. 86 and 87 were
written from use and from reading the code, not reproduced and not read by a
second verifier; 85 is not a defect but behaviour nobody has watched happen.
